...
def getArgs(argv=None):
    ...
    parser.add_argument('--roa_reg_loss_beta', default=0.1, type=float, help='the weight of the decrease condition in the total objective')
    ...
    parser.add_argument('--roa_reg_loss_coeff', default=0.000, type=float, help='the weight of the roa size loss in the total objective')
